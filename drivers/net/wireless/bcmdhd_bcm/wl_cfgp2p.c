...
//static s8 ioctlbuf[WLC_IOCTL_MAXLEN]; /*delete warning*/
static s8 scanparambuf[WLC_IOCTL_SMLEN];
//static s8 *smbuf = ioctlbuf; /*delete warning*/
            ...
            const wl_event_msg_t *e, void *data)
{
	...
	if (wl == NULL || wl->p2p == NULL) {
		CFGP2P_ERR(("wl is null or wl->p2p is null.\n"));
		return BCME_BADARG;
	}
