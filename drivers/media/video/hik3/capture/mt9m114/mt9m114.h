...
{0xC92D, 0xA0, 0x00, 1},
{0xC92E, 0x3C, 0x00, 1},
{0xC92F, 0x04, 0x00, 1},   //sharpness gain bright
{0xC930, 0x02, 0x00, 1},   //sharpness threshold bright
{0xC931, 0x64, 0x00, 1},   //cam_ll_stop_demosaic
{0xC932, 0x05, 0x00, 1},   //cam_ll_stop_ap_gain
{0xC933, 0x08, 0x00, 1},   //sharpness threshold dark
{0xC934, 0x00, 0x00, 1},
{0xC935, 0x00, 0x00, 1},
{0xC936, 0x00, 0x00, 1},
{0xC937, 0x00, 0x00, 1},
...
//20121017
{0xC942, 0x46, 0x00, 1},      //cam_ll_start_contrast_gradient  default=0x3c  
...
{0x0080, 0xFFF1, 0x00, 2}, 	// COMMAND_REGISTER
//  POLL  COMMAND_REGIGISTER::HOST_COMMAND_0 =>  0x00
// 读{0x080， 判断其最最低位是否为0， 如果不为0，则delay 5ms，然后继续读，
// 直到为0或者   50ms襰以上
...
{0xC930, 0x02, 0x00, 1},   //sharpness threshold bright
{0xC931, 0x64, 0x00, 1},   //cam_ll_stop_demosaic
{0xC932, 0x05, 0x00, 1},   //sharpness gain dark
{0xC933, 0x08, 0x00, 1},   //sharpness threshold dark
//denoise
{0xC934, 0x2E, 0x00, 1},
{0xC935, 0x10, 0x00, 1},
...
//For gamma
{0xC87A, 0x3A  , 0x00, 1}, 	// CAM_AET_TARGET_AVERAGE_LUMA
{0x098E, 0xB00C, 0x00, 2},       // LOGICAL_ADDRESS_ACCESS [BLACKLEVEL_MAX_BLACK_LEVEL]
{0xB00C, 0x1B  , 0x00, 1}, 	// BLACKLEVEL_MAX_BLACK_LEVEL
{0xB004, 0x0004, 0x00, 2},       // BLACKLEVEL_ALGO
...
{0xC92A, 0xAF, 0x00, 1},      //0x79
{0xC92B, 0xD0, 0x00, 1},     //cam_ll_end_saturation
{0xC92D, 0x60, 0x00, 1},
