 ...
 */
enum pull_updown hdmi_pullud_array2_u9508[] = {NOPULL, NOPULL, PULLDOWN, PULLDOWN, -INVALID,};
struct block_config hdmi_config_u9508[] = {
	[NORMAL] = {hdmi_func_normal, hdmi_pullud_array1, hdmi_drv_array1},
	[GPIO] = {hdmi_func_gpio, hdmi_pullud_array2_u9508, hdmi_drv_array1},
	[LOWPOWER] = {hdmi_func_gpio, hdmi_pullud_array2_u9508, hdmi_drv_array1},
};

/*kpc key pad  3X3:keypad_in0~keypad_in2, keypad_out0~keypad_out2*/
enum pull_updown kpc_pullud_array2_u9508[] = {PULLUP, PULLUP, PULLDOWN, \
	PULLDOWN, PULLDOWN, PULLDOWN, -INVALID,};
struct block_config kpc_config_u9508[] = {
	[NORMAL] = {kpc_func_array2, kpc_pullud_array2_u9508, kpc_drv_array1},
	[GPIO] = {kpc_func_array2, kpc_pullud_array1, kpc_drv_array1},
	[LOWPOWER] = {kpc_func_array2, kpc_pullud_array2_u9508, kpc_drv_array1},
};


struct block_table block_config_phone_u9508_es[] = {
	...
	BLOCK_CONFIG("block_kpc", &block_kpc, kpc_config_u9508)
	...
	BLOCK_CONFIG("block_hdmi", &block_hdmi, hdmi_config_u9508)
...
struct block_table block_config_phone_u9508_cs[] = {
	BLOCK_CONFIG("block_i2c0", &block_i2c0, i2c0_config)
	BLOCK_CONFIG("block_i2c1", &block_i2c1, i2c1_config)
